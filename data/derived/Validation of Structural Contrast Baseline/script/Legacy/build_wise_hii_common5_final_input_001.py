...
"""
Build final common5 input tables for standard and topological tracks.
...
------
Primary shortlist:
- data/derived/Validation of Structural Contrast Baseline/wise_hii_catalog/tables_5/wise_hii_tables_5_common5_shortlist.csv

Mass candidates preference:
...
Outputs
-------
data/derived/Validation of Structural Contrast Baseline/input/standard/wise_hii_common5/
data/derived/Validation of Structural Contrast Baseline/input/topological/wise_hii_common5/

Design rule
-----------
- Use the SAME 5 targets for both standard and topological input.
- Standard input remains mass-free baseline-oriented.
- Topological input carries mass/proxy fields and readiness metadata.
- This script creates final input files, unlike tables_* staging scripts.

Windows example
---------------
python "data\\derived\\Validation of Structural Contrast Baseline\\script\\build_wise_hii_common5_final_input_001.py"
"""
...
def main() -> int:
    ...
    shortlist = read_csv_required(shortlist_path)
    ...
    # Standard final input: intentionally mass-free
    standard_cols = [
    ...
    # Topological final input: same five targets + mass/proxy fields
    topo_cols = [
        "wise_name", "catalog_class", "input_group", "priority_rank", "glon", "glat", "ra", "dec",
        "radius_arcsec", "hii_region_name", "membership", "dist_kpc",
        "fits_source_service", "fits_band", "fits_url", "fits_downloadable",
