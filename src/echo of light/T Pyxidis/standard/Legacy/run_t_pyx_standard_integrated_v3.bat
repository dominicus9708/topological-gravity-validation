...
python "src\echo of light\T Pyxidis\standard\t_pyx_standard_integrated_pipeline_v3.py" ^
  ...
  --output-root "results\Echo of Light\output\T Pyxidis\standard\integrated_standard_v3"
pause
