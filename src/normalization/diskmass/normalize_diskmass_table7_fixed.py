...
# -----
# normalize_diskmass_table7_fixed.py
#
# DiskMass table7 전용 정규화 스크립트
# -----
...
DEFAULT_INPUT = Path(r"data/raw/diskmass/J_ApJS_276_59_table7_The_DiskMass_Survey_(DMS)_XI_Full_Ha_sample_(Swaters+, 2025).tsv")
DEFAULT_OUTPUT = Path(r"data/derived/diskmass/J_ApJS_276_59_table7_The_DiskMass_Survey_(DMS)_XI_Full_Ha_sample_(Swaters+, 2025).csv")

HEADER_LINE_1BASED = 115
DATA_LINE_1BASED = 118
...
def main() -> int:
    ...
    print(f"[OK] normalized table7 file -> {out}")
    return 0
