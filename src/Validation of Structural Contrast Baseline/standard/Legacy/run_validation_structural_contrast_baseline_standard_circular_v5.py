...
Standard pipeline (circular schematic, revised v5)
...
def save_circular_plot_for_target(target: pd.Series, zone: TargetZones, out_dir: Path) -> None:
    ...
    # Labels positioned on each arc's x-location, above the blue horizontal line, parallel to each other
    label_y_offset = 10
    label_05 = make_radius_label("0.5R", zone.inner_outer_arcsec)
    label_10 = make_radius_label("1.0R", zone.shell_outer_arcsec)
    label_18 = make_radius_label("1.8R", zone.bg_outer_arcsec)
...
def main() -> int:
    ...
    print("=" * 72)
    print("Validation of Structural Contrast Baseline - standard pipeline (circular v5)")
    print("=" * 72)
